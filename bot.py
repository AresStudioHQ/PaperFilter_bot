...
MESSAGES = {
    "zh_hant": {
        ...
        "pro_text": (
            ...
            "• 搜尋：50 次/日\n"
            "• 深度導讀：10 次/日\n"
            "• /review + /gap + /chat：5 次/日\n"
            "• Drive：30 篇/月\n"
            "• 廣告：有\n\n"
            "🔧 <b>Basic</b>\n"
            "• 搜尋：150 次/日\n"
            "• 深度導讀：30 次/日\n"
            "• /review + /gap + /chat：15 次/日\n"
            "• Drive：100 篇/月\n"
            "• 無廣告\n\n"
            "⭐ <b>Standard</b>\n"
            "• 搜尋：400 次/日\n"
            "• 深度導讀：80 次/日\n"
            "• /review + /gap + /chat：40 次/日\n"
            "• Drive：500 篇/月\n"
            "• 每月 AI 分析報告\n\n"
            "💎 <b>Premium</b>\n"
            "• 搜尋：1,000 次/日\n"
            "• 深度導讀：200 次/日\n"
            "• /review + /gap + /chat：100 次/日\n"
            "• Drive：無限\n"
            "• 每週 AI 分析報告\n\n"
            "👑 <b>Ultra</b>\n"
            "• 搜尋：無限\n"
    ...
    "en": {
        ...
        "pro_text": (
            ...
            "• Search: 50/day\n"
            "• Deep Reading: 10/day\n"
            "• /review + /gap + /chat: 5/day\n"
            "• Drive: 30 papers/mo\n"
            "• Ads: Yes\n\n"
            "🔧 <b>Basic</b>\n"
            "• Search: 150/day\n"
            "• Deep Reading: 30/day\n"
            "• /review + /gap + /chat: 15/day\n"
            "• Drive: 100 papers/mo\n"
            "• Ad-Free\n\n"
            "⭐ <b>Standard</b>\n"
            "• Search: 400/day\n"
            "• Deep Reading: 80/day\n"
            "• /review + /gap + /chat: 40/day\n"
            "• Drive: 500 papers/mo\n"
            "• Monthly AI Report\n\n"
            "💎 <b>Premium</b>\n"
            "• Search: 1,000/day\n"
            "• Deep Reading: 200/day\n"
            "• /review + /gap + /chat: 100/day\n"
            "• Drive: Unlimited\n"
            "• Weekly AI Report\n\n"
            "👑 <b>Ultra</b>\n"
            "• Search: Unlimited\n"
            "• Deep Reading: 500/day\n"
    ...
    "ja": {
        ...
        "pro_text": (
            ...
            "• 検索：50 回/日\n"
            "• 詳細解説：10 回/日\n"
            "• /review + /gap + /chat：5 回/日\n"
            "• Drive：30 本/月\n"
            "• 広告：あり\n\n"
            "🔧 <b>Basic</b>\n"
            "• 検索：150 回/日\n"
            "• 詳細解説：30 回/日\n"
            "• /review + /gap + /chat：15 回/日\n"
            "• Drive：100 本/月\n"
            "• 広告なし\n\n"
            "⭐ <b>Standard</b>\n"
            "• 検索：400 回/日\n"
            "• 詳細解説：80 回/日\n"
            "• /review + /gap + /chat：40 回/日\n"
            "• Drive：500 本/月\n"
            "• 月次 AI レポート\n\n"
            "💎 <b>Premium</b>\n"
            "• 検索：1,000 回/日\n"
            "• 詳細解説：200 回/日\n"
            "• /review + /gap + /chat：100 回/日\n"
            "• Drive：無制限\n"
            "• 週次 AI レポート\n\n"
            "👑 <b>Ultra</b>\n"
            "• 検索：無制限\n"
