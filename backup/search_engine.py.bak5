...
def fetch_paper_multi_source(
    ...
    for p in unique_candidates:
        ...
        if filter_mode == "top_tier":
            ...
            top_journal_bonus = 30 if is_top else 0
            mode_score = citation_weight + top_journal_bonus
            ...
            top_journal_bonus = 15 if is_top else 0
            oa_bonus = 10 if is_oa else 0
            mode_score = citation_weight + top_journal_bonus + oa_bonus
